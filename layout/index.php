...
<div class="row">
    ...
    foreach($mapeos as $mapeo){
        ...
        if($estado_espacio == "DISPONIBLE"){ ?>
            <div class="col">
                <center>
                    <h2 style="color: #ffffff;"><?php echo $nro_espacio?></h2>
                    <button class="btn" style="border: #686868; background-color: #28a745 ;border: 2px solid; border-radius: 5px; width: 100%; height: 156px">
