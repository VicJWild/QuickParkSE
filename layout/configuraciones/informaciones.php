...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <p class="fs-1" style="font-size: 40px"><b>Listado de informaciones</b></p>
            ...
            <a href="create_informaciones.php" class="btn btn-outline-primary">Registrar nuevo</a> <br><br>
            <table id="table_id" class="table table-bordered table-sm table-striped">
                ...
                foreach($informacions as $informacion){
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                                <a href="update_configuraciones.php?id=<?php echo $id_informacion; ?>" class="btn btn-outline-success">Editar</a>
                                <a href="delete_configuraciones.php?id=<?php echo $id_informacion; ?>" class="btn btn-outline-danger">Borrar</a>
                            </center>
                        </td>
                    </tr>
                    <?php
