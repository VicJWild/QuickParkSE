...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <p class="fs-1" style="font-size: 40px"><b>Actualización de la Información</b></p>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-success">
                        <div class="card-header">
                            <h3 class="card-title"><i><b>¡Registre los datos con mucho cuidado!</b></i></h3>
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <div class="row" style="margin-top: 10px">
                                ...
                                <div class="col-md-6">
                                    <button class="btn btn-outline-success btn-block" id="btn_actualizar_informacion">
                                        <b>Actualizar</b>
                                    </button>
                                </div>
                            </div>
