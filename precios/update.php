...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <p class="fs-1" style="font-size: 40px"><b>Actualización de Precios</b></p>
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button class="btn btn-outline-success" id="btn_actualizar_precio"><b>Actualizar Precio</b></button>
                                </div>
                            </div>
