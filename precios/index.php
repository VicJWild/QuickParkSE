...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <p class="fs-1" style="font-size: 40px"><b>Listado de Precios</b></p>
                ...
                <div class="col-md-10">
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i><b>Precios Establecidos</b></i></h3>
                            ...
                            <table id="table_id" class="table table-bordered table-sm table-striped">
                                ...
                                foreach($datos_precios as $datos_precio){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a href="update.php?id=<?php echo $id_precio; ?>" class="btn btn-outline-success"><b>Editar</b></a>
                                            </center>
                                        </td>
                                    </tr>
                                    <?php
