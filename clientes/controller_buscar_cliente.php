...
foreach($buscars as $buscar){
    ...
    $telefono_cliente = $buscar['telefono_cliente'];
}
...
if($nombre_cliente == ""){
    ...
    <div class="form-group row">
        <label for="staticEmail" class="col-sm-3 col-form-label">CI: <span><b style="color: red">*</b></span></label>
        <div class="col-sm-9">
            <input type="text" class="form-control" id="nit_ci<?php echo $id_map;?>">
        </div>
    </div>
    <div class="form-group row">
        <label for="staticEmail" class="col-sm-3 col-form-label">Telefono: <span><b style="color: red">*</b></span></label>
        <div class="col-sm-9">
            <input type="text" class="form-control" id="telefono_cliente<?php echo $id_map;?>">
        </div>
    </div>
    <?php
}else{
    ...
    <div class="form-group row">
        <label for="staticEmail" class="col-sm-3 col-form-label">Telefono: <span><b style="color: red">*</b></span></label>
        <div class="col-sm-9">
            <input type="text" class="form-control" id="telefono_cliente<?php echo $id_map;?>" value="<?php echo $telefono_cliente; ?>">
        </div>
    </div>
    <?php
}
