...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <p class="fs-1" style="font-size: 40px"><b>Edición de los datos del Cliente</b></p>
                ...
                <div class="col-md-10">
                    ...
                    <div class="card card-outline card-success">
                        <div class="card-header">
                            <h3 class="card-title"><i><b>Datos del Cliente</b></i></b></h3>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <button class="btn btn-outline-success" id="btn_actualizar_cliente">
                                                <b>Actualizar</b>
                                            </button>
                                        </div>
                                    </div>
